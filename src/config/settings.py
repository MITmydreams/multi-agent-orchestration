...
class Settings(BaseSettings):
    """Central configuration for the multi-account orchestration system."""
    ...
    # --- Database ---
    database_url: str = "postgresql+asyncpg://ops:ops@localhost:5432/ops_orchestrator"
    ...
    # --- Product API ---
    product_api_url: str = "https://api.example.com"
    product_api_key: str = ""
    product_ws_url: str = "wss://ws.example.com"
    product_app_url: str = "https://t.me/example_bot/app"
    ...
    outreach_ratio_limit: float = 0.15

    # --- Scheduling ---
    scheduler_interval_seconds: int = 900  # 15 min per round
    nurture_days: int = 45
    engagement_cooldown_days: int = 14
    ...
    web_discovery_queries: list[str] = [
        "announcement", "referral programs", "community", "community product",
        "tech game", "play to earn", "ton game", "clicker game",
        "mini app", "nft game", "tech earning", "telegram game",
    ]
